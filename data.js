// ЗАПОЛНЕНИЕ САЙТА — редактируй здесь
// -----------------------------------------------------------------
...
// reserved: true — товар помечается как "забронирован" (ставишь вручную, когда договорился с кем-то).
const PRODUCTS = [
  {
    id: 1,
    price: "2 500 ₽",
    reserved: false,
    images: ["images/item1-1.svg", "images/item1-2.svg", "images/item1-3.svg"],
    title: {
      ru: "Виниловый проигрыватель",
      en: "Vinyl Record Player",
      de: "Schallplattenspieler",
      zh: "黑胶唱片机"
    },
    desc: {
      ...
      de: "Voll funktionsfähig, warmer Klang. Kleiner Kratzer auf dem Deckel, beeinflusst den Klang nicht.",
  ...
  },
  {
    ...
    price: "900 ₽",
    reserved: true,
    images: ["images/item2-1.svg", "images/item2-2.svg"],
    title: {
  ...
  },
  {
    ...
    price: "1 200 ₽",
    reserved: false,
    images: ["images/item3-1.svg", "images/item3-2.svg", "images/item3-3.svg"],
    title: {
